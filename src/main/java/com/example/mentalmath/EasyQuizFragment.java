...
public class EasyQuizFragment extends Fragment {// Define Java Variables:
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_easy_quiz, container, false);         // Connect to the layout file 'fragment_training.xml'.
