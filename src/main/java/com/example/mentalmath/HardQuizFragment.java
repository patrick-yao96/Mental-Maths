...
public class HardQuizFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_medium_quiz, container, false);         // Connect to the layout file 'fragment_training.xml'.
        ...
        final StringRequest SR1 = new StringRequest(Request.Method.GET, API_URL_H,                    // Request a string response from the API URL.
